           ...
           <div className="container my-10  min-h-80">
               <div className="md:grid grid-cols-2 px-20 justify-center items-center">
                   ...
                   <div className='text-center'>
                     <text className="yellow-700 text-xl font-bold">Your return request has been successfully placed!!! </text>
                         <p className="text-center text-green-800 text-xl p-4">
                            Our delivery partner will contact you within 2 business days to pick up the product from your address.
